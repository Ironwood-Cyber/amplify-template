...
export class GettingStartedPage extends EditorPane {
	...
	private async buildCategoriesSlide() {
		...
		const header = $('.header', {},
			...
			$('p.subtitle.description', {}, localize({ key: 'gettingStarted.editingEvolved', comment: ['Shown as subtitle on the Welcome page.'] }, "Transparent assessments. Better visibility. Powered by VSCode."))
		);
